...
<div class="text-center">
  ...
  <c:if test="${curBlock > 0}">[<a href="guestList?pag=${(curBlock-1)*blockSize + 1}" class="text-decoration-none text-dark link-primary">이전블럭</a>]</c:if>
  ...
  <c:if test="${curBlock < lastBlock}">[<a href="guestList?pag=${(curBlock+1)*blockSize + 1}" class="text-decoration-none text-dark link-primary">다음블럭</a>]</c:if>
