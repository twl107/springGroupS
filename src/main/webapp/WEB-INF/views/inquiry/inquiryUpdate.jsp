...
<div class="container">
  <br/>
	<form name="myform" method="post" enctype="multipart/form-data">
		<h2 style="font-weight: 600">☞ 1:1 문의 수정하기</h2>
		<br/>
		<table class="table table-bordered">
			...
			<tr>
			  <td colspan='2' class="text-center">
			    <input type="button" value="수 정" onclick="fCheck()" class="btn btn-success w-25"/> &nbsp;
			    <input type="reset" value="다시입력" class="btn btn-warning w-25"/> &nbsp;
			    <input type="button" value="돌아가기" onclick="location.href='${ctp}/inquiry/inquiryView?idx=${vo.idx}&pag=${pag}';" class="btn btn-primary w-25"/>
			  </td>
			</tr>
		</table>
		<p><br/></p>
