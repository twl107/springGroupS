...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <!-- <a href="http://192.168.50.57:9090/springGroupS/" class="w3-bar-item w3-button w3-padding-large">HOME</a> -->
	    ...
	    <c:if test="${sLevel < 3}">
		    ...
		    <div class="w3-dropdown-hover w3-hide-small">
		      ...
		      <div class="w3-dropdown-content w3-bar-block w3-card-4">
		        ...
		        <a href="${ctp}/study1/mail/mailForm" class="w3-bar-item w3-button">메일연습</a>
		        ...
		        <a href="${ctp}/study1/rangeSlider/rangeSlider" class="w3-bar-item w3-button">rangeSlider연습</a>
		      </div>
		    </div>
		    <div class="w3-dropdown-hover w3-hide-small">
		      ...
		      <div class="w3-dropdown-content w3-bar-block w3-card-4">
		        ...
		        <a href="${ctp}/study2/thumbnail/thumbnailForm" class="w3-bar-item w3-button">썸네일연습
		      </div>
		    </div>
	    </c:if>
	    <div class="w3-dropdown-hover w3-hide-small">
